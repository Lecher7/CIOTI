...
If (CStr(UploadFormRequest("MM_update")) = "form1" And CStr(UploadFormRequest("MM_recordId")) <> "") Then
  ...
  MM_columnsStr = "PRO_TYPE|none,none,NULL|PRO_NAME|',none,''|PRO_DATED|',none,NULL|PRO_PRICE|',none,''|PRO_SHIP|',none,''|PRO_INFO|',none,''|PRO_BRAND|',none,''|PRO_IMAGE|',none,''|PRO_DESCRIPTION|',none,''"
...
%>
                ...
                <tr valign="baseline"> 
                  <td nowrap align="right" valign="middle">PRODUCT IMAGE:</td>
                  <td valign="middle"> <input name="PRO_IMAGE" type="file" class="form" id="PRO_IMAGE" onChange="checkOneFileUpload(this,'GIF,JPG,JPEG,BMP,PNG',false,'','','','','','','')" value="<%=(rsProducts.Fields.Item("PRO_IMAGE").Value)%>" size="45"> 
                  </td>
                </tr>
                <tr> 
                ...
                <tr valign="baseline" align="center"> 
                  <td nowrap colspan="2"> <input type="submit" class="form" onClick="MM_validateForm('PRO_NAME','','R','PRO_DATED','','R','PRO_PRICE','','RisNum','PRO_SHIP','','RisNum','PRO_INFO','','R','PRO_DESCRIPTION','','R');return document.MM_returnValue" value="Update This Product"> 
                  </td>
                </tr>
              </table></td>
